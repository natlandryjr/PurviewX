...
echo ""
echo -e "${YELLOW}🐳 STEP 1: Build and Push Docker Image${NC}"
echo "Run these commands in your PurviewX project directory:"
echo ""
echo "   # Build the Docker image"
echo "   docker build -t purviewx:latest ."
echo ""
echo "   # Tag for your Azure Container Registry"
...
echo ""
echo -e "${YELLOW}🔐 STEP 2: Create Microsoft Entra ID App Registration${NC}"
echo "1. Go to Azure Portal (GCC): https://portal.azure.us"
echo "2. Navigate to Microsoft Entra ID > App registrations"
echo "3. Click 'New registration'"
echo "4. Configure:"
echo "   - Name: PurviewX Application"
echo "   - Supported account types: This organization only"
echo "   - Redirect URI: Single-page application (SPA)"
echo "   - URI: https://$APP_URL"
echo "5. Click 'Register'"
echo "6. Note the Application (client) ID and Directory (tenant) ID"
echo "7. Go to 'Certificates & secrets' > 'New client secret'"
echo "8. Create secret and copy the VALUE immediately"
echo "9. Go to 'API permissions' and add these Microsoft Graph permissions:"
echo "   - Application.Read.All"
echo "   - Directory.Read.All"
echo "   - Policy.Read.All"
echo "   - InformationProtectionPolicy.ReadWrite"
echo "   - DataLossPreventionPolicy.ReadWrite"
echo "   - RecordsManagement.ReadWrite.All"
echo "   - eDiscovery.ReadWrite.All"
echo "   - Audit.ReadWrite.All"
echo "10. Click 'Grant admin consent for [Your Tenant]'"
echo ""
echo -e "${YELLOW}⚙️ STEP 3: Update App Settings${NC}"
echo "Replace 'your-client-id', 'your-tenant-id', and 'your-client-secret' with your actual values:"
echo ""
echo "   az webapp config appsettings set \\"
echo "     --resource-group $RESOURCE_GROUP \\"
echo "     --name $APP_SERVICE_NAME \\"
echo "     --settings \\"
echo "       ENTRA_CLIENT_ID='your-client-id' \\"
echo "       ENTRA_TENANT_ID='your-tenant-id' \\"
echo "       ENTRA_CLIENT_SECRET='your-client-secret'"
echo ""
...
echo "   curl https://$APP_URL:3002/healthz"
echo "3. Open your browser and go to: https://$APP_URL"
echo "4. Verify the PurviewX login screen loads"
echo ""
